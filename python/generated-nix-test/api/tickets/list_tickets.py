...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ErrorResponse | ListTicketsResponse200 | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ErrorResponse | ListTicketsResponse200]:
    return Response(
...
) -> Response[ErrorResponse | ListTicketsResponse200]:
    """ List tickets
...
def sync(
    ...
    *,
...
) -> ErrorResponse | ListTicketsResponse200 | None:
    """ List tickets
    ...
    Returns:
        ErrorResponse | ListTicketsResponse200
     """
