...
class InvoiceAttributes:
    """ 
        Attributes:
            ...
            stage (InvoiceAttributesStage | Unset):
            download_pdf_url (None | str | Unset):
            ephemeral_open_download_pdf_url (None | str | Unset):
     """
    ...
    stage: InvoiceAttributesStage | Unset = UNSET
    download_pdf_url: None | str | Unset = UNSET
    ephemeral_open_download_pdf_url: None | str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_ephemeral_open_download_pdf_url(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
