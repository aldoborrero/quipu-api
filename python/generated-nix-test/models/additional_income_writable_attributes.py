...
from ..models.additional_income_writable_attributes_kind import AdditionalIncomeWritableAttributesKind
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="AdditionalIncomeWritableAttributes")



@_attrs_define
class AdditionalIncomeWritableAttributes:
    """ 
        Attributes:
            kind (AdditionalIncomeWritableAttributesKind):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        kind = AdditionalIncomeWritableAttributesKind(d.pop("kind"))
        ...
        additional_income_writable_attributes = cls(
            kind=kind,
            issue_date=issue_date,
        ...
        additional_income_writable_attributes.additional_properties = d
        return additional_income_writable_attributes
