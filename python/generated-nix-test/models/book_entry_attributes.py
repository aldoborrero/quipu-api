...
T = TypeVar("T", bound="BookEntryAttributes")



@_attrs_define
class BookEntryAttributes:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        book_entry_attributes.additional_properties = d
        return book_entry_attributes
