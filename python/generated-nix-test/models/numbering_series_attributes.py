...
class NumberingSeriesAttributes:
    """ 
        Attributes:
            prefix (str | Unset):  Example: F-.
            default (bool | Unset):
            amending (bool | Unset):
            deletable (bool | Unset):
            applicable_to (None | str | Unset):
            is_valid (bool | Unset):
            applies_to (NumberingSeriesAttributesAppliesTo | Unset):
     """
    ...
    applicable_to: None | str | Unset = UNSET
    is_valid: bool | Unset = UNSET
    applies_to: NumberingSeriesAttributesAppliesTo | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_applicable_to(data: object) -> None | str | Unset:
            if data is None:
                return data
