...
class PaysheetResource:
    """ 
        Attributes:
            id (str | Unset):
            type_ (Literal['paysheets'] | Unset):
            attributes (PaysheetAttributes | Unset):
            relationships (PaysheetResourceRelationships | Unset):
     """

    id: str | Unset = UNSET
    type_: Literal['paysheets'] | Unset = UNSET
    attributes: PaysheetAttributes | Unset = UNSET
    relationships: PaysheetResourceRelationships | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal['paysheets'] | Unset , d.pop("type", UNSET))
