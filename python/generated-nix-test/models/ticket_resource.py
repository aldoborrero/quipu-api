...
class TicketResource:
    """ 
        Attributes:
            id (str | Unset):
            type_ (Literal['tickets'] | Unset):
            attributes (TicketAttributes | Unset):
            relationships (TicketResourceRelationships | Unset):
     """

    id: str | Unset = UNSET
    type_: Literal['tickets'] | Unset = UNSET
    attributes: TicketAttributes | Unset = UNSET
    relationships: TicketResourceRelationships | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal['tickets'] | Unset , d.pop("type", UNSET))
