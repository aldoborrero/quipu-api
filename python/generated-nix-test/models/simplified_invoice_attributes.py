...
from ..models.simplified_invoice_attributes_kind import SimplifiedInvoiceAttributesKind
from ..models.simplified_invoice_attributes_stage import SimplifiedInvoiceAttributesStage
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="SimplifiedInvoiceAttributes")



@_attrs_define
class SimplifiedInvoiceAttributes:
    """ 
        Attributes:
            ...
            kind (SimplifiedInvoiceAttributesKind | Unset):
            total_amount_without_taxes (str | Unset):
            vat_amount (str | Unset):
            retention_amount (str | Unset):
            notes (None | str | Unset):
            stage (SimplifiedInvoiceAttributesStage | Unset):
            download_pdf_url (None | str | Unset):
     """
    ...
    kind: SimplifiedInvoiceAttributesKind | Unset = UNSET
    total_amount_without_taxes: str | Unset = UNSET
    vat_amount: str | Unset = UNSET
    retention_amount: str | Unset = UNSET
    notes: None | str | Unset = UNSET
    stage: SimplifiedInvoiceAttributesStage | Unset = UNSET
    download_pdf_url: None | str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_kind,  Unset):
            ...
            kind = SimplifiedInvoiceAttributesKind(_kind)
        ...
        if isinstance(_stage,  Unset):
            ...
            stage = SimplifiedInvoiceAttributesStage(_stage)




        def _parse_download_pdf_url(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        simplified_invoice_attributes = cls(
            number=number,
        ...
        simplified_invoice_attributes.additional_properties = d
        return simplified_invoice_attributes
