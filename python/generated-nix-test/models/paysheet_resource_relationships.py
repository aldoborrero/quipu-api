...
T = TypeVar("T", bound="PaysheetResourceRelationships")



@_attrs_define
class PaysheetResourceRelationships:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paysheet_resource_relationships = cls(
            contact=contact,
        )


        paysheet_resource_relationships.additional_properties = d
        return paysheet_resource_relationships
