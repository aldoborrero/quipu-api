...
T = TypeVar("T", bound="AccountingSubcategoryResourceRelationships")



@_attrs_define
class AccountingSubcategoryResourceRelationships:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        accounting_subcategory_resource_relationships = cls(
            accounting_category=accounting_category,
        )


        accounting_subcategory_resource_relationships.additional_properties = d
        return accounting_subcategory_resource_relationships
