...
from ..models.additional_income_attributes_kind import AdditionalIncomeAttributesKind
...
T = TypeVar("T", bound="AdditionalIncomeAttributes")



@_attrs_define
class AdditionalIncomeAttributes:
    """ 
        Attributes:
            ...
            kind (AdditionalIncomeAttributesKind | Unset):
    ...
    kind: AdditionalIncomeAttributesKind | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_kind,  Unset):
            ...
            kind = AdditionalIncomeAttributesKind(_kind)
        ...
        additional_income_attributes = cls(
            number=number,
        ...
        additional_income_attributes.additional_properties = d
        return additional_income_attributes
