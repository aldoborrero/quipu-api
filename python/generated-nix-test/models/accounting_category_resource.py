...
class AccountingCategoryResource:
    """ 
        Attributes:
            id (str | Unset):
            type_ (Literal['accounting_categories'] | Unset):
            attributes (AccountingCategoryAttributes | Unset):
     """

    id: str | Unset = UNSET
    type_: Literal['accounting_categories'] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal['accounting_categories'] | Unset , d.pop("type", UNSET))
