...
class AttachmentResource:
    """ 
        Attributes:
            id (str | Unset):
            type_ (Literal['attachments'] | Unset):
            attributes (AttachmentResourceAttributes | Unset):
     """

    id: str | Unset = UNSET
    type_: Literal['attachments'] | Unset = UNSET
    attributes: AttachmentResourceAttributes | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal['attachments'] | Unset , d.pop("type", UNSET))
