...
class UserResourceAttributes:
    """ 
        Attributes:
            ...
            name (str | Unset):
            surnames (str | Unset):
            locale (str | Unset):  Example: es.
            sign_up_draft_data (None | Unset | UserResourceAttributesSignUpDraftDataType0):
            is_full_admin (bool | Unset):
     """

    email: str | Unset = UNSET
    name: str | Unset = UNSET
    surnames: str | Unset = UNSET
    locale: str | Unset = UNSET
    sign_up_draft_data: None | Unset | UserResourceAttributesSignUpDraftDataType0 = UNSET
    is_full_admin: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        sign_up_draft_data: dict[str, Any] | None | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_sign_up_draft_data(data: object) -> None | Unset | UserResourceAttributesSignUpDraftDataType0:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(None | Unset | UserResourceAttributesSignUpDraftDataType0, data)
