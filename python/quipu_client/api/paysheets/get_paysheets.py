...
from ...models.get_paysheets_filterfield_query import GetPaysheetsFilterfieldQuery
from ...models.get_paysheets_filterpayment_status import GetPaysheetsFilterpaymentStatus
from ...models.paysheet_collection import PaysheetCollection
...
def _get_kwargs(
    *,
    ...
    filterpayment_status: GetPaysheetsFilterpaymentStatus | Unset = UNSET,
    filtercontact_id: None | str | Unset = UNSET,
    filterfield_query: GetPaysheetsFilterfieldQuery | Unset = UNSET,
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> PaysheetCollection | None:
    if response.status_code == 200:
        response_200 = PaysheetCollection.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[PaysheetCollection]:
    return Response(
...
def sync_detailed(
    *,
    ...
    sort: str | Unset = UNSET,
    pagenumber: int | Unset = UNSET,
) -> Response[PaysheetCollection]:
    """Retrieve all paysheets

    Args:
        filterq (None | str | Unset):
        filterperiod (None | str | Unset):  Example: 2015-Q1.
        filterpayment_status (GetPaysheetsFilterpaymentStatus | Unset):
        filtercontact_id (None | str | Unset):
        filterfield_query (GetPaysheetsFilterfieldQuery | Unset):
