...
class SimplifiedInvoiceAttributes:
    ...
    kind: Union[Unset, SimplifiedInvoiceAttributesKind] = UNSET
    ...
    stage: Union[Unset, SimplifiedInvoiceAttributesStage] = UNSET
