...
T = TypeVar("T", bound="GetPaysheetsFilterfieldQuery")


@_attrs_define
class GetPaysheetsFilterfieldQuery:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_paysheets_filterfield_query = cls(
            field=field,
            term=term,
        )

        get_paysheets_filterfield_query.additional_properties = d
        return get_paysheets_filterfield_query
