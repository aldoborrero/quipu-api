...
class TicketResourceRelationships:
    """ 
        Attributes:
            ...
            amending_tickets (Union[Unset, RelationshipLinkageArray]):
            amended_ticket (Union['RelationshipLinkageType0', None, Unset]):
     """
    ...
    amending_tickets: Union[Unset, 'RelationshipLinkageArray'] = UNSET
    amended_ticket: Union['RelationshipLinkageType0', None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        amending_tickets: Union[Unset, dict[str, Any]] = UNSET
        if not isinstance(self.amending_tickets, Unset):
            amending_tickets = self.amending_tickets.to_dict()

        amended_ticket: Union[None, Unset, dict[str, Any]]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_amended_ticket(data: object) -> Union['RelationshipLinkageType0', None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
