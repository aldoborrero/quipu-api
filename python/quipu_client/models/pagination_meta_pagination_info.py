...
T = TypeVar("T", bound="PaginationMetaPaginationInfo")



@_attrs_define
class PaginationMetaPaginationInfo:
    """ 
        Attributes:
            total_pages (Union[Unset, int]):  Example: 2.
            current_page (Union[Unset, int]):  Example: 1.
            total_results (Union[Unset, int]):  Example: 23.
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pagination_meta_pagination_info = cls(
        ...
        pagination_meta_pagination_info.additional_properties = d
        return pagination_meta_pagination_info
