...
T = TypeVar("T", bound="GetTicketsFilterfieldQuery")


@_attrs_define
class GetTicketsFilterfieldQuery:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_tickets_filterfield_query = cls(
            field=field,
            term=term,
        )

        get_tickets_filterfield_query.additional_properties = d
        return get_tickets_filterfield_query
