...
class PaysheetAttributes:
    """ 
        Attributes:
            ...
            kind (Union[Unset, PaysheetAttributesKind]):
            net_pay (Union[Unset, str]):
            gross_pay (Union[Unset, str]):
            employee_ss_amount (Union[Unset, str]):
            employee_retention (Union[Unset, str]):
            company_ss_amount (Union[Unset, str]):
     """
    ...
    kind: Union[Unset, PaysheetAttributesKind] = UNSET
    net_pay: Union[Unset, str] = UNSET
    gross_pay: Union[Unset, str] = UNSET
    employee_ss_amount: Union[Unset, str] = UNSET
    employee_retention: Union[Unset, str] = UNSET
    company_ss_amount: Union[Unset, str] = UNSET
