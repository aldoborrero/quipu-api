...
T = TypeVar("T", bound="InvoiceRelationshipsItems")


@_attrs_define
class InvoiceRelationshipsItems:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        invoice_relationships_items = cls(
            data=data,
        )

        invoice_relationships_items.additional_properties = d
        return invoice_relationships_items
