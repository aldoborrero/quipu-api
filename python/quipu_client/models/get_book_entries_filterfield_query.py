...
T = TypeVar("T", bound="GetBookEntriesFilterfieldQuery")


@_attrs_define
class GetBookEntriesFilterfieldQuery:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_book_entries_filterfield_query = cls(
            field=field,
            term=term,
        )

        get_book_entries_filterfield_query.additional_properties = d
        return get_book_entries_filterfield_query
