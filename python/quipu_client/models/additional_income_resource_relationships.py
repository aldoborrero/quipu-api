...
T = TypeVar("T", bound="AdditionalIncomeResourceRelationships")



@_attrs_define
class AdditionalIncomeResourceRelationships:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        additional_income_resource_relationships = cls(
        ...
        additional_income_resource_relationships.additional_properties = d
        return additional_income_resource_relationships
