...
class ContactResource:
    """ 
        Attributes:
            id (Union[Unset, str]):
            type_ (Union[Literal['contacts'], Unset]):
            attributes (Union[Unset, ContactAttributes]):
     """

    id: Union[Unset, str] = UNSET
    type_: Union[Literal['contacts'], Unset] = UNSET
    attributes: Union[Unset, 'ContactAttributes'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Union[Literal['contacts'], Unset] , d.pop("type", UNSET))
