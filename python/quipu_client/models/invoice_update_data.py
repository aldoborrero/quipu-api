...
from ..models.invoice_update_data_type import InvoiceUpdateDataType
...
T = TypeVar("T", bound="InvoiceUpdateData")
...
class InvoiceUpdateData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = InvoiceUpdateDataType(d.pop("type"))
        ...
        invoice_update_data.additional_properties = d
        return invoice_update_data
