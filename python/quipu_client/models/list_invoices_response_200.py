...
class ListInvoicesResponse200:
    """ 
        Attributes:
            data (Union[Unset, list['InvoiceResource']]):
            meta (Union[Unset, PaginationMeta]):
     """

    data: Union[Unset, list['InvoiceResource']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data or []):
            data_item = InvoiceResource.from_dict(data_item_data)
        ...
        list_invoices_response_200.additional_properties = d
