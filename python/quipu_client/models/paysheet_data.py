...
from ..models.paysheet_data_type import PaysheetDataType
...
T = TypeVar("T", bound="PaysheetData")
...
class PaysheetData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paysheet_data.additional_properties = d
