...
if TYPE_CHECKING:
  ...
  from ..models.ticket_writable_relationships_items import TicketWritableRelationshipsItems





T = TypeVar("T", bound="TicketWritableRelationships")



@_attrs_define
class TicketWritableRelationships:
    """ 
        Attributes:
            numeration (Union['RelationshipLinkageType0', None, Unset]):
            items (Union[Unset, TicketWritableRelationshipsItems]):
     """

    numeration: Union['RelationshipLinkageType0', None, Unset] = UNSET
    items: Union[Unset, 'TicketWritableRelationshipsItems'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_items,  Unset):
            ...
            items = TicketWritableRelationshipsItems.from_dict(_items)




        ticket_writable_relationships = cls(
            numeration=numeration,
            items=items,
        )


        ticket_writable_relationships.additional_properties = d
        return ticket_writable_relationships
