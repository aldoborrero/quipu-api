...
class ContactWritableAttributes:
    """ 
        Attributes:
            ...
            supplier_number (Union[Unset, str]):
            employee_number (Union[Unset, str]):
            a3_nom_id (Union[Unset, str]):
            is_supplier_of_direct_goods (Union[Unset, bool]):
            description (Union[Unset, str]):
            bank_account_number (Union[Unset, str]):
            bank_account_swift_bic (Union[Unset, str]):
    ...
    employee_number: Union[Unset, str] = UNSET
    a3_nom_id: Union[Unset, str] = UNSET
    is_supplier_of_direct_goods: Union[Unset, bool] = UNSET
    description: Union[Unset, str] = UNSET
    bank_account_number: Union[Unset, str] = UNSET
    bank_account_swift_bic: Union[Unset, str] = UNSET
