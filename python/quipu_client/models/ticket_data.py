...
from ..models.ticket_data_type import TicketDataType
...
class TicketData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ticket_data.additional_properties = d
        return ticket_data
