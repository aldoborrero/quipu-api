...
from ..models.invoice_create_data_type import InvoiceCreateDataType
...
T = TypeVar("T", bound="InvoiceCreateData")
...
class InvoiceCreateData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = InvoiceCreateDataType(d.pop("type"))
        ...
        invoice_create_data = cls(
            type_=type_,
            attributes=attributes,
            relationships=relationships,
        )

        invoice_create_data.additional_properties = d
        return invoice_create_data
