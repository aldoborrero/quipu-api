...
T = TypeVar("T", bound="GetInvoicesFilterfieldQuery")


@_attrs_define
class GetInvoicesFilterfieldQuery:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_invoices_filterfield_query = cls(
            field=field,
            term=term,
        )

        get_invoices_filterfield_query.additional_properties = d
        return get_invoices_filterfield_query
