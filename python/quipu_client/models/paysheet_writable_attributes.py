...
class PaysheetWritableAttributes:
    """ 
        Attributes:
            ...
            net_pay (Union[Unset, float]): Net pay amount
            gross_pay (Union[Unset, str]):
            employee_ss_amount (Union[Unset, float]): Employee social security amount
            employee_retention (Union[Unset, float]): Employee retention amount
            company_ss_amount (Union[Unset, float]): Company social security amount
     """
    ...
    gross_pay: Union[Unset, str] = UNSET
    employee_ss_amount: Union[Unset, float] = UNSET
    employee_retention: Union[Unset, float] = UNSET
    company_ss_amount: Union[Unset, float] = UNSET
